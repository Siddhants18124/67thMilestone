...
const Footer = () => {
  return (
    ...
    <footer class="bg-white">
      <div class="mx-auto max-w-screen-3xl px-4 pb-6 pt-16 xl:ml-7 sm:px-6  lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-2 xl:ml-38 md:ml-32">
            <div class="text-center sm:text-left">
              <p class="text-4xl font-bold  text-black ">Support</p>

              <ul class="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    class="text-black text-xl transition hover:text-gray-700/75"
                    href="/"
                  >
                    FAQ's
                  </a>
            ...
            <div class="text-center sm:text-left xl:ml-18">
              <p class="text-4xl font-bold text-black">Social Media</p>
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-black transition hover:text-gray-400"
                >
