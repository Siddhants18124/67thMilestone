...
function Navbar() {
  return (
    <nav className="fixed z-20 w-full p-1 py-4 mobile_l:p-4 text-white flex flex-col justify-center gap-2 items-center md:flex-row md:justify-between md:px-6 lg:w-5/6 lg:mx-auto">
